...
object ChiSquareTestExample {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // After that, they create a data value as an example of information, creating a data frame
    // using that value in two columns and finalizing with the pValues, the degrees of freedom and the statistics.
    val data = Seq(
